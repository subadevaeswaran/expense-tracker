...
function BudgetItem({budget}) {
  ...
  return (
    <Link href={'expenses/'+budget.id} >
        <div className='p-5 border rounded-lg shadow-sm hover:shadow-lg cursor-pointer h-[170px] hover:bg-slate-50'>
            ...
            <div className='mt-5'>
                ...
                <h2 className='text-xs text-red-600 font-semibold mb-2'>- ₹{budget?.totalSpend?budget.totalSpend: 0} Spend</h2>
                <h2 className='text-xs text-green-600 font-semibold'>₹{budget?.amount-budget?.totalSpend} Remaining</h2>  
                </div>
